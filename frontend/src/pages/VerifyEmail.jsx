  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      addToast({
        ...
        message: 'Welcome to ReminderFlow! Your account is active.',
        duration: 5000
      });
      navigate('/dashboard');
    } catch (err) {
  ...
  const handleResend = async () => {
    ...
    try {
      ...
      addToast({
        ...
        message: 'A new 6-digit code has been logged to your backend console/messages.',
        duration: 8000
      });
      ...
      <div className="flex-1 flex flex-col justify-center px-8 sm:px-16 lg:px-24 py-12">
        <div className="max-w-sm w-full mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label htmlFor="code" className="input-label">Verification code (6 digits)</label>
              <input
                id="code"
                type="text"
                maxLength={6}
          ...
          <div className="mt-6 flex flex-col items-center justify-center gap-2">
            <button
              ...
              className="flex items-center gap-1 text-xs font-semibold focus:outline-none hover:underline disabled:opacity-50"
      ...
      >
        ...
        <div className="relative z-10 px-16 text-center">
          ...
          <p className="text-xs max-w-xs mx-auto leading-relaxed" style={{ color: 'rgb(var(--clr-ink-muted))' }}>
            This check ensures only legitimate owners can complete activation.
          </p>
        </div>
      </div>
    </div>
